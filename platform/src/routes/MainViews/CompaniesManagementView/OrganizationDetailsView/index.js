...
import { OrganizationTier, PERMISSIONS, PERMISSION_ENTITIES, NOT_AVAILABLE } from 'config/consts';
...
export const OrganizationDetailsView = () => {
  ...
  const isSmbCompany = selectedRootCompany?.tier === OrganizationTier.SMB;
  ...
  const { name, segment } = selectedOrganization;
  const companyNumbers = '4';
  ...
  return isB1Enabled ? (
    <>
      <div style={{ position: 'relative', padding: 20 }}>
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
            <Icon name="business" color="#000000" style={{ marginRight: 5.5 }} />
            <Typography variantName="title3" textColor="black">
              {t('company.generalInformation')}
            </Typography>
          </div>
          <Icon name="create" color="#5AC0B1" />
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', marginTop: 18 }}>
          <div style={{ flexBasis: '25%' }}>
            <Typography variantName="overline" style={{ textTransform: 'uppercase', marginBottom: 6 }}>
              {t('organization.name')}
            </Typography>
            <Typography variantName="body2">{name}</Typography>
          </div>
          <div style={{ flexBasis: '25%' }}>
            <Typography variantName="overline" style={{ textTransform: 'uppercase', marginBottom: 6 }}>
              {t('organization.segment')}
            </Typography>
            <Typography
          ...
          <div style={{ flexBasis: '25%' }}>
            <Typography variantName="overline" style={{ textTransform: 'uppercase', marginBottom: 6 }}>
              {t('organization.companies')}
            </Typography>
            <Typography variantName="body2">{companyNumbers}</Typography>
          </div>
        </div>
      </div>
      <LineBreak />
      <div style={{ position: 'relative', padding: 20 }}>
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
            <Icon name="share" color="#000000" style={{ marginRight: 5.5 }} />
            <Typography variantName="title3" textColor="black">
        ...
        <div style={{ display: 'flex', flexDirection: 'row', marginTop: 18 }}>
          <div style={{ flexBasis: '25%' }}>
            <Typography variantName="overline" style={{ textTransform: 'uppercase', marginBottom: 6 }}>
              {t('forms.deliveryPreferences.title')}
            </Typography>
            <Typography variantName="body2">
              {selectedOrganization.deliverToMainContact ? t(`forms.deliveryPreferences.checkboxLabel`) : NOT_AVAILABLE}
            </Typography>
          </div>
        </div>
      </div>
