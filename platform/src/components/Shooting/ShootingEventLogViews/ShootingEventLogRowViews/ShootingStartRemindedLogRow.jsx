...
const ShootingStartRemindedLogRow = ({ event, classes }) => {
  ...
  return (
    <div key={event.id} style={{ margin: 5 }}>
      <h4 className={classes.eventText}>
        {translations.t('shootingEvents.shootingStartRemindedMessage', {
          subject,
...
export default _.flow([withStyles(styles), connect()])(ShootingStartRemindedLogRow);
