...
const ShootingCompletedLogRow = ({ event, classes, isBoom }) => {
  ...
  let translationComponent = translations.t('shootingEvents.shootingCompletedMessage', { subject });
  if (!isBoom) {
    translationComponent = translations.t('shootingEvents.shootingCompletedCompanyMessage');
  }
...
export default _.flow([withStyles(styles), connect()])(ShootingCompletedLogRow);
