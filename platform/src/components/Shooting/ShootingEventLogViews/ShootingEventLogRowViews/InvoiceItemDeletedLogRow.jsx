...
import { elaborateInvoiceItemEventMessage } from '../../../../config/utils';
...
const InvoiceItemDeletedLogRow = ({ event, classes }) => {
  ...
  const translationString = elaborateInvoiceItemEventMessage(`${invoiceItemType}_DELETED`, user);
  // RETURN CONDITION
...
export default _.flow([withStyles(styles), connect()])(InvoiceItemDeletedLogRow);
