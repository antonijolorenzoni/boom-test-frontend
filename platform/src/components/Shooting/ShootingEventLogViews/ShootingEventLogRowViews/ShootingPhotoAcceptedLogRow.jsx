...
const ShootingPhotoAcceptedLogRow = ({ event, classes, isBoom }) => {
  ...
  let translationComponent = translations.t('shootingEvents.shootingPhotoAcceptedMessage', { subject, photographer: photographerFull });
  if (!isBoom) {
    translationComponent = translations.t('shootingEvents.shootingPhotoAcceptedCompanyMessage');
  }
...
export default _.flow([withStyles(styles), connect()])(ShootingPhotoAcceptedLogRow);
